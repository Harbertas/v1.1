...
void mix(std::string read_vardas, std::string write_vardas, deque<duomenys>& sarasas, int & fileLength, double &timeTaken){
  ...
  std::cout << fileLength << " eiluciu failo nuskaitymas tiesiai į eilučių deque užtruko: "<< diff.count() << " s\n";
